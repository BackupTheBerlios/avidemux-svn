...
printf(  "*********************\n");
	...
	REGISTERX("crop","Crop","Crop the image by removing some pixels from top/bottom/left/right",VF_CROP,1,crop_create,crop_script);
...
//	REGISTERX("lavdeint","Lavcodec Deinterlacer",VF_LAVDEINT,1,lavdeint_create,lavdeint_script);
	...
	REGISTERX("mergefield","Merge Fields","Merge two picture as if they were the two fields of a twice as big picture",VF_MERGEFIELDS,1,mergefield_create,mergefield_script);
