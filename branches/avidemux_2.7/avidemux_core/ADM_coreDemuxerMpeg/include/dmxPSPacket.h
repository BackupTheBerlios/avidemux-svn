...
/**
    \class psPacket
*/
class ADM_COREDEMUXERMPEG6_EXPORT psPacket : public ADMMpegPacket
{
protected:
...
class ADM_COREDEMUXERMPEG6_EXPORT psPacketLinear : public psPacket
{
protected:
        uint8_t  myPid;
        uint64_t startAt;
...
*/
class ADM_COREDEMUXERMPEG6_EXPORT psPacketLinearTracker : public psPacketLinear
{
protected:
