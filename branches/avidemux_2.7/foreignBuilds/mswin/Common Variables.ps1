...
[string] $spiderMonkey_includeDir_gcc_x86 = Join-Path $devDir "js-1.7.0-gcc-x86\src"
[string] $spiderMonkey_libDir_gcc_x86 = Join-Path $spiderMonkey_includeDir_gcc_x86 "WINNT6.1_OPT.OBJ"

[string] $spiderMonkey_includeDir_gcc_x86_64 = Join-Path $devDir "js-1.7.0-gcc-x86-64\src"
[string] $spiderMonkey_libDir_gcc_x86_64 = Join-Path $spiderMonkey_includeDir_gcc_x86_64 "WINNT6.1_OPT.OBJ"

[bool] $spiderMonkey_useSystemVersion_msvc10 = $false
