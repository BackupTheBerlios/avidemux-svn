...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:output encoding="ENCODINGTAG" method="html" indent="yes" doctype-public="-//W3C//DTD HTML 4.01 Transitional//EN"/>
	...
	<html>
	<head>
<link title="new" rel="stylesheet" href="PATHTOCSS" type="text/css"/>
	<title>Avidemux 
...
<!--info goes here-->
				...
				<br/>
				<a class="altlink" href="/main/en/icons.xml">Icons</a>
				<br/>
