...
class ffmpegEncoderCQ : public ffmpegEncoder
  	{
     	protected :
          ...
          public :
          			...
          			ffmpegEncoderCQ(uint32_t width,uint32_t height,FF_CODEC_ID id)   :
...
class ffmpegEncoderCBR : public ffmpegEncoder
  	{
     	protected :
          ...
          public :
          			...
          			ffmpegEncoderCBR(uint32_t width,uint32_t height,FF_CODEC_ID id)  
             										 : ffmpegEncoder(width,height,id)
             				{
								         _br=1000;
                   			} ;
...
class ffmpegEncoderVBR : public ffmpegEncoderCQ
  	{
     	protected :
          ...
          public :
					virtual 	uint8_t init( uint32_t val,uint32_t fps1000) ;
						ffmpegEncoderVBR(uint32_t width,uint32_t height,FF_CODEC_ID id)
														 : ffmpegEncoderCQ(width,height,id)
										{
											 	_internal=1;
											}
						ffmpegEncoderVBR(uint32_t width,uint32_t height,uint8_t inter,FF_CODEC_ID id)
														 : ffmpegEncoderCQ(width,height,id)
										{
											 	_internal=inter;
											}
...
class ffmpegEncoderVBRExternal : public ffmpegEncoderCQ
  	{
     	protected :
                   	uint8_t encodeVBR(	uint8_t 	*in, 	uint8_t 	*out,
...
class ffmpegEncoderFFV1 : public ffmpegEncoder
  	{
     	protected :
          ...
          public :
          			...
          			ffmpegEncoderFFV1(uint32_t width,uint32_t height,FF_CODEC_ID id)   :
             								 ffmpegEncoder(width,height,id)
             				{
...
class ffmpegEncoderFFMjpeg : public ffmpegEncoder
  	{
     	protected :
          ...
          public :
          			...
          			ffmpegEncoderFFMjpeg(uint32_t width,uint32_t height,FF_CODEC_ID id)   :
             								 ffmpegEncoder(width,height,id)
             				{
						_qual=4;
                   			} ;
